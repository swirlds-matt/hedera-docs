...
{% hint style="info" %}
There is no limit on the number of token IDs that can be associated to an account. Reference [HIP-367](https://hips.hedera.com/hip/hip-367). Reference [HIP-367](https://hips.hedera.com/hip/hip-367).
{% endhint %}
