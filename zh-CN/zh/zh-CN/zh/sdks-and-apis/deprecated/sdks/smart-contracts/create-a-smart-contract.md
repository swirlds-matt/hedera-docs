...
| **Staked ID**                    | <p>The node account or node ID to which this contract account is staking to. Update the node or account this account is staked to. See <a href="https://hips.hedera.com/hip/hip-406">HIP-406.</a><br><br><strong>Note:</strong> Accounts cannot stake to contract accounts. This will fixed in a future release. This will fixed in a future release.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                            |
