...
* [Docker](https://www.docker.com/) (`>= v20.10.x)` installed and open on your machine. [Docker](https://www.docker.com/) (`>= v20.10.x)` installed and opened on your machine. Run `docker -v` in your terminal to check the version you have installed.
...
![](../../.gitbook/assets/docker command up postgres.png)<figcaption>

Console output after starting both containers.</figcaption></figure>
...
![](../../.gitbook/assets/importer hedera console (1).png)<figcaption>

Mirror Importer process console</figcaption></figure>
